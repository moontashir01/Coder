...
# The default, and the answer to every unrecognised key. Flask stays the default
# deliberately: it is the stack with the deeper guarantees (see `gaps` on the
# Node adapter), so an accident lands on the better-verified path.
DEFAULT_KEY = "flask"
